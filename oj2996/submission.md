...
```text
โจทย์ให้เรียงตัวอักษรใหม่จากหลังไปหน้า และเป็นพิมพ์เล็ก
Input:
ข้อความภาษาอังกฤษ 5 ตัว

Output:
เรียงตัวอักษรใหม่จากหลังไปหน้า และเป็นพิมพ์เล็ก

Constraints:
ต้องแปลงให้ทุกตัวเป็นตัวพิมพ์เล็ก
```
...
```text
Step 1: รับข้อความ
Step 2: เรียงจากหลังไปหน้า
Step 3: เปลี่ยนทั้งหมดเป็นพิมพ์เล็ก
Step 4: แสดงผล
```
...
```text
เหมือนแผนแรกแต่รวมขั้นตอนเรียงตัวอักษรกับเปลี่ยนเป็นพิมพ์เล็กเข้าด้วยกัน เพราะสั้นกว่า
```
...
```text
มีตัวอักษรทั้งพิมพ์เล็กและใหญ่
```
...
```text
เพราะถ้าทำถูกผลลัพต้องออกมาอ่านได้เหมือนเดิม ไม่สลับตำแหน่งจนเพี้ยน
```
...
```text
เพื่อนที่เป็นคู่แพร์
```

เขาช่วยอะไร

```text
แนะนำให้เขียนโค้ดรวมบรรทัดจะได้สั้นกว่า
```

คุณยังทำอะไรด้วยตนเอง

```text
คิด เขียนโค้ด ทดสอบ และส่ง OJ ด้วยตนเองทั้งหมด
```
