...
```text
input :
รับจำนวนนับ 4 บรรทัด ค่าเริ่มต้น (A), ค่าสุดท้าย (B), ตัวหาร (d) และเศษที่ต้องการ (r)

Output :
แสดงจำนวนนับทั้งหมดในช่วงตั้งแต่ A ถึง B ที่เมื่อหารด้วย d แล้วเหลือเศษเท่ากับ r
...
Step 2 : ตรวจสอบว่าตัวเลขในลูปหารด้วย d แล้วเหลือเศษ r หรือไม่
Step 3 : ถ้าใช่ ให้บวกค่าตัวแปรนับเพิ่มทีละ 1
Step 4 : แสดงผล
```
...
```text
เหมือนแผนแรก รับค่า A, B, d และ r เข้ามา จากนั้นตั้งตัวแปรสะสมเป็น 0 แล้วใช้ลูปนับ
```
...
```text
ดูว่านับจำนวนตัวที่หารลงตัวเหลือเศษ r ได้ถูกต้อง
```
...
```text
r เป็น 0 เพื่อดูว่าโปรแกรมสามารถนับตัวเลขที่หารด้วย d ลงตัวพอดีได้ถูกต้องไหม
```
...
```text
ทดสอบกรณีที่ไม่มีตัวเลขเหลือเศษ r เลย เพื่อเช็คว่าโปรแกรมไม่เกิด error
```
