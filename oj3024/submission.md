...
```text
ถ้าคะแนนของคนที่มากสุดและน้อยสุดห่างกันเกินสองจะเป็น Surprising
...
Output:
ถ้าคะแนนของคนที่มากสุดกับน้อยสุดห่างกันเกินสองให้พิมพ์ "Surprising"
ถ้าไม่ให้พิมพ์ "Not surprising"

Constraints:
คะแนนเป็นจำนวนจริง อาจมีคนที่มีคะแนนมากสุดมากกว่าคนเดียว
...
```text
Step 1: รับค่าคะแนนทั้งหมด
Step 2: รับค่าคะแนนสูงสุด
Step 3: นำค่าคะแนนสูงสุงมาลบกับทั้งหมดแล้วหารสองเพื่อหาค่าคะแนนน้้อยสุด
Step 4: นำคะแนนทั้งหมดลบคะแนนที่น้อยที่สุด
Step 5: น้อยกว่า 2 แสดงผล "Not surprising"
Step 6: มากกว่า 2 แสดงผล "Surprising"
```
...
```text
เอาคะแนนสูงสุดคูณ 2 มาลบออกจากคะแนนรวม เพื่อดูคะแนนต่ำสุดที่เป็นไปได้ และใช้ if ในกรณีที่ออกมาติดลบให้เป็น 0
```
...
```text
แนะนำให้คูณสองเพื่อหากรณีที่น้อยที่สุด และวิธีแก้ x ติดลบ
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดทั้งหมด ทดสอบ ส่ง OJ ด้วยตนเอง
```
