...
Input:
รับค่า n 
n บรรทัด รับคำสั่ง + หรือ -

Output:
แสดงคะแนนรวมสุดท้ายเป็นจำนวนเต็มหลังจากทำครบทุกคำสั่ง โดยเริ่มจาก 0 คะแนน

Constraints:
คำสั่ง + เพิ่ม 10 คะแนน คำสั่ง - ลด 5 คะแนน
```
...
```text
Step 1: รับค่า n
Step 2: กำหนดตัวแปรคะแนนเริ่มต้น score = 0
Step 3: ใช้ลูป for วนทำงานตามจำนวน n ครั้ง
Step 4: ถ้าเป็น '+' ให้บวกคะแนนเพิ่ม 10 ถ้าเป็น '-' ให้ลบคะแนนออก 5
Step 5: แสดงผลรวมคะแนน
```
