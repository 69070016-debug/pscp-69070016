...
```text
แปลงหน่วยอุณหภูมิ kelvin farenheit rankine

Input:
จำนวนจริงค่าอุณหภูมิเริ่มต้น
อักษร C, F, K, R ตัวย่อหน่วยอุณหภูมิเริ่มต้น
อักษร C, F, K, R ตัวย่อหน่วยอุณหภูมิที่ต้องการ

Output:
อุณหภูมิที่เปลี่ยนหน่วยแล้ว เป็นทศนิยมสองตำแหน่ง

Constraints:
ต้องใช้สูตรเฉพาะในการเปลี่ยนหน่วย
```
...
Step 2: รับหน่วยเริ่มต้น
Step 3: รับหน่วยที่ต้องการจะแปลงเป็น
Step 4: แปลงค่าอุณหภูมิจากหน่วยเริ่มต้นเป็นหน่วยที่ต้องการ
Step 5: แสดงผล
```
...
```text
หลังจากรับค่าอุณหภูมิเปลี่ยนเป็นค่าหน่วย c เลยทันที เพื่อความง่ายในการแปลงเป็นหน่วยอื่นๆ จากคำแนะนำของเพื่อน
```
...
```text
ทดสอบสูตรเปลี่ยนหน่วย Fahrenheit ไปเป็น Kelvin
```
...
```text
ถ้าหน่วยเหมือนเดิมค่าต้องเท่าเดิม
```
...
```text
เพื่อดูว่าาค่าติดลบสามารถคำนวนได้ตามปกติไหม
```
...
```text
เพื่อนที่เป็ฯคู่แพร์
```

เขาช่วยอะไร

```text
แนะนำว่าเปลี่ยนเป็นเซลเซียสก่อนจะทำให้เปลี่ยนหน่วยง่ายกว่า
```

คุณยังทำอะไรด้วยตนเอง

```text
คิด เขียนโค้ด และส่งงานด้วยตนเองทั้งหมด
```
