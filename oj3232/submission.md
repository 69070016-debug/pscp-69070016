...
```text
Input:
รับ ระยะกระโดดครั้งแรก และระยะทางเป้าหมาย

Output:
แสดงจำนวนการกระโดดว่าอย่างน้อยกี่ครั้ง จึงจะไปถึงเป้าหมาย ถ้าไปไม่ถึง ให้พิมพ์ -1

Constraints:
แต่ละครั้งที่กระโดด ระยะจะลดลงครั้งละ 2 เมตร
```
...
```text
Step 1: รับค่า ระยะกระโดด และเป้าหมาย
Step 2: ใช้ลูป while ลบระยะทางออกจาก Y และลดระยะกระโดดลงทีละ 2 เมตร
Step 3: หยุดลูปเมื่อถึงเป้าหมาย หรือระยะกระโดดเหลือ 0
Step 4: แสดงผล
```
...
```text
กรณีปกติ เพื่อดูว่าคำนวณการลดระยะกระโดดทีละ 2 และนับจำนวนครั้งได้ถูกต้อง
```
...
```text
เพื่อดูว่าโปรแกรมหยุดวนลูปและแสดงผล -1 ได้ เมื่อระยะกระโดดหมด แต่ไม่ถึงเป้าหมาย
```
...
```text
ทดสอบกรณีขอบเขตที่ระยะกระโดดครั้งแรกมากกว่าระยะเป้าหมาย
```
