...
```text
หาตัวเลขตั้งแต่ N จนถึง 0 ที่หารด้วย 10 ลงตัว

Input:
จำนวนเต็มบวก

Output:
ตัวเลขตั้งแต่ N ถึง 0 ที่หารด้วย 10 ลงตัว คั่นด้วยช่องว่างบรรทัดเดียวกัน
 
Constraints:
คำนวนตัวเลขแบบถอยหลัง
```
...
```text
Step 1: รับค่า N
Step 2: วนลูปคำนวนตั้งแต่ N ลงมาจนถึง 0 ว่าหารด้วย 10 ลงตัวหรือไม่
Step 3: ถ้าหารลงตัว ให้พิมพ์ตัวเลขนั้นออกมาพร้อมคั่นด้วยช่องว่าง
Step 4: แสดงผล
```
...
```text
ใช้แผนแรก ใช้ลูปเพื่อคำนวนถอยหลังจาก N ถึง 0
```
...
```text
เพื่อดูว่าพิมพ์เลข 0 ออกมาได้ถูกต้องและไม่เกิด error
```
