...
```text
แสดงสีที่ได้เมื่อป้อนแม่สีสองสีมาผสมกัน

Input:
รับแม่สีแรก และแม่สีที่สอง

Output:
แดงเหลือง = ส้ม
แดงฟ้า = ม่วง
เหลืองฟ้า = เขียว
ถ้าสีเดียวกันก็ตอบสีนั้นๆ
สีอื่นๆให้ตอบerror

Constraints:
ผสมได้แค่แม่สีเท่านั้น ลำดับการกรอกไม่มีผลกับผลลัพ
```
...
```text
Step 1: รับค่าสีที่หนึ่ง
Step 2: รับค่าสีที่สอง
Step 3: ถ้าเป็นแดงเหลือ หรือ เหลืองแดงให้พิมพ์  "Orange"
Step 4: ถ้าเป็นแดงฟ้า หรือ ฟ้าแดงให้พิมพ์ "Violet"
Step 5: ถ้าเป็ยเหลืองฟ้า หรือฟ้าเหลืองให่พิมพ์ "Green"
Step 6: ถ้าเป็นสีแดงทั้งคู่ให้พิมพ์ "Red"
Step 7: ถ้าเป็นสีเหลืองทั้งคู่ให้พิมพ์ "Yellow"
Step 8: ถ้าเป็นสีฟ้าทั้งคู่ให้พิมพ์ "Blue"
Step 9: ถ้าเป็นสีอื่นๆให้พิมพ์ "Error" 
```
...
```text
เหมือนวิธีแรก ใช้and และ or เพื่อเขียนเงื่อนไข
```
...
```text
ผสมสีเดียวกัน ต้องได้สีเดียวกัน
```
...
```text
ใช้สีอื่นที่นอกเหนือจากแม่สีมาผสม ไม่ควรผสมได้
```
