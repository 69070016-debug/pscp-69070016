...
```text
Input:
รับข้อความเป็นรหัสย่อของไพ่

Output:
แสดงชื่อเต็มของไพ่

Constraints:
ตัวอักษรภาษาอังกฤษรับได้ทั้งพิมพ์เล็กและพิมพ์ใหญ่ แต้มไพ่มีทั้งหลักหน่วยและหลักสิบ
```
...
```text
Step 1 : รับรหัสไพ่และแปลงเป็นตัวพิมพ์ใหญ่ทั้งหมด
Step 2 : แปลงตัวอักษรแต้มเป็นชื่อเต็ม
Step 3 : แปลงตัวอักษรดอกเป็นชื่อเต็ม
Step 4 : แสดงผล
```
...
```text
เหมือนแผนแรก แยกแต้มและดอกโดยเช็คตำแหน่งตัวอักษร โดยถ้าหลักที่สองเป็น '0' แสดงว่าเป็นแต้ม '10' จากนั้นใช้เงื่อนไข if-elif ตรวจสอบแล้วพิมพ์ผลลัพธ์
```
...
```text
กรณีตัวอักษรพิมพ์เล็ก และเลขหลักสิบ
```
