...
output:
นับจำนวนสระในข้อความ แล้วพิมพ์สระที่มีพร้อมจำนวน คั่นด้วยเครื่องหมาย :

Constraints:
ไม่สนว่าเป็นตัวพิมพ์เล็กหรือพิมพ์ใหญ่
พิมพ์เฉพาะสระที่นับได้ เรียงตามลำดับ a, e, i, o, u
```
...
```text
Step 1: รับข้อความ และแปลงเป็นตัวพิมพ์เล็ก
Step 2: สร้างลิสต์ของสระ ['a', 'e', 'i', 'o', 'u']
Step 3: วนลูปเช็คสระแต่ละตัว แล้วนับจำนวนสระตัวนั้นในข้อความ
Step 4: ถ้าสระตัวนั้นมีมากกว่า 0 ตัว ให้แสดงผล
```
...
```text
เหมือนแผนแรก รับข้อความแล้วแปลงเป็นตัวพิมพ์เล็ก .lower() แล้วลูปนับสระ
```
...
```text
มีสระทั้งพิมพ์ใหญ่และพิมพ์เล็ก
```
