...
Input:
รับข้อมูลผลรางวัล
รับข้อมูลสลากที่ซื้อ

Output:
แสดงเงินรางวัลสูงสุดที่ได้รับ

Constraints:
รับรางวัลที่มีมูลค่ามากที่สุดเพียงรางวัลเดียว
```
...
```text
Step 1: รับค่าผลรางวัลและสลากที่ซื้อ
Step 2: ใช้เงื่อนไข if-elif-else เปรียบเทียบรหัสและเลขสลากตามลำดับมูลค่ารางวัลสูงสุดไปน้อยสุด
Step 3: ตรวจสอบเลขตรงกันทั้ง 5 หลักและหมวดตัวอักษร
Step 4: ตรวจสอบการถูกเลขท้าย 3 ตัว และเลขท้าย 2 ตัวทั้งแบบหมวดตรงและหมวดไม่ตรง
Step 5: ตรวจสอบกรณีถูกเฉพาะหมวดตัวอักษร
Step 6: แสดงผลรางวัล
```
...
```text
เหมือนแผนแรก เช็คเงื่อนไขจากรางวัลใหญ่ลงมา
```
...
```text
ถูกเฉพาะเลขท้าย 3 ตัว และหมวดตัวอักษรตรงกัน รางวัล 2,000 บาท
```
...
```text
ถูกรางวัลตัวอักษรอย่างเดียว 20 บาท
```
...
```text
ทดสอบกรณีที่ไม่ตรงกับเงื่อนไขใดๆ
```
