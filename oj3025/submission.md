...
```text
Input:
รับจำนวนเต็ม แทนหมายเลขเดือน
รับจำนวนเต็ม แทนวันที่

Output:
พิมพ์ชื่อฤดูกาลเป็นตัวพิมพ์เล็กภาษาอังกฤษ ตามเงื่อนไขวันที่และเดือนที่กำหนด

Constraints:
เปลี่ยนฤดูในวันที่ 21 ของเดือนที่หาร3 ลงตัว
เดือนที่ 3, 6, 9, 12 จะมีสองฤดูในเดือนเดียว
```
...
Step 1: รับค่าเดือน
Step 2: รับค่าวันที่
Step 3: นำเดือนมาหารด้วย 3 เพื่อหาช่วงฤดูกาล
Step 4: ดูว่าวันที่และเดือนตรงกับฤดูอะไร
Step 5: แสดงผล
```
...
```text
ใช้แผนแรก เอาเดือนหาร 3 แบ่งช่วงฤดู แล้วใช้ if ดูเงื่อนไขวันที่ว่าตรงกับฤดูอะไร
```
...
```text
เป็นวันปกติ ไม่ได้อยู่ในเดือนที่คาบเกี่ยวสองฤดู
```
