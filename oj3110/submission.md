...
Constraints:
หากเส้นทางไม่อยู่ในตารางให้แสดงข้อความว่า Error
```
...
```text
Step 1 : รับรหัสต้นทางและปลายทาง
Step 2 : รับค่าน้ำหนักพัสดุ
Step 3 : คำนวณราคาตามสูตร ค่าธรรมเนียมเริ่มต้น + (น้ำหนัก คูณ ราคาต่อกก.) ของแต่ละเส้นทาง
Step 4: แสดงผลราคาเป็นทศนิยม 2 ตำแหน่ง หรือ Error ถ้าไม่อยู่ในเงื่อนไข
```
...
```text
เหมือนแผนแรก โดยใช้ .split() แยกต้นทางและปลายทางออกจากกัน รับน้ำหนักเป็น float แสดงผลทศนิยม 2 ตำแหน่ง หรือ Error
```
...
```text
ดูว่าโปรแกรมแสดงผลข้อความ Error ได้ถูกต้องหรือไม่
```
