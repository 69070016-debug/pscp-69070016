...
Input :
รับสถานะสมาชิก
รับจำนวนรายการสินค้า
n บรรทัดถัดมารับราคาสินค้าแต่ละรายการ

Output :
แสดงยอดทั้งหมดทศนิยม 2 ตำแหน่ง 

Constraints :
ถ้านักเรียนเป็นสมาชิก ลด 5% ถ้าไม่เป็นสมาชิก แต่ยอดรวมเกิน 500 บาท ลด 3%
ต้องใช้วิธีปัดเศษทศนิยมแบบมาตรฐาน (round half up)
```
...
```text
Step 1: รับค่าสถานะสมาชิก
Step 2: รับจำนวนสินค้า n
Step 3: ใช้ลูปรับราคาสินค้า และบวกราคาทั้งหมด
Step 4: ตรวจสอบเงื่อนไขส่วนลด
Step 5: คำนวณราคาหลังหักส่วนลด
Step 6: แสดงผลทศนิยม 2 ตำแหน่ง
```
...
```text
เหมือนแผนแรก ใช้ฟังก์ชันปัดเศษแบบ Round Half Up ให้ได้ทศนิยม 2 ตำแหน่ง
```
...
```text
กรณีคำนวณแล้วได้ทศนิยมตำแหน่งที่สามเป็นเลข 5 เพื่อเช็คการปัดเศษแบบ Round Half Up
```
