...
| OJ submission ID, if submitted | 632308 |
| OJ status | Pass |
...
```text
สอนวิธีใช้ฟังชั่น Decimal, ROUND_HALF_UP
```
...
```text
เห็นว่าการใช้ float อาจเกิดปัญหาเรื่องความคลาดเคลื่อนของทศนิยม และสอนวิธีกำหนดตำแหน่งทศนิยม 2 ตำแหน่ง พร้อมวิธีกำหนดเงื่อนไขการปัดเศษ(Half Up) ให้ตรงตามโจทย์
```
...
```text
ตรวจ input output format ทดสอบใน VS Code ลองรันกับเคสที่ลงท้ายด้วย .5 หรือ .005
```
...
```text
วิธีใช้ฟังชั่น Decimal, ROUND_HALF_UP
```
