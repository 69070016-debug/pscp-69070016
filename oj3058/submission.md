...
```text
คำนวณหาจำนวนอิฐก้อนเล็ก ที่น้อยที่สุดที่ต้องใช้ในการสร้างสะพาน

Input:
รับจำนวนอิฐก้อนเล็ก
รับจำนวนอิฐก้อนใหญ่
รับค่าความยาวสะพานที่ต้องการ

Output:
แสดงจำนวนอิฐเล็กที่ต้องใช้ หรือแสดง -1 ถ้าทำไม่ได้

Constraints:
ใช้อิฐก้อนเล็กให้น้อยที่สุด
```
...
Step 3: รับค่าความยาวสะพาน 
Step 2: ใช้ลูปในการนับอิฐทีละก้อนจนกว่าจะครบความยาวสะพาน
Step 3: ตรวจสอบจำนวนอิฐก้อนเล็กที่ต้องใช้
Step 4: แสดงผลจำนวนอิฐเล็กที่ใช้ หรือแสดง -1 ถ้าทำไม่ได้
```
...
```text
ใช้ if ในการดูเงื่อนไขว่าอิฐพอไหม หาจำนวนอิฐก้อนใหญ่ที่ต้องการด้วย goal // 5 ถ้าอิฐก้อนใหญ่ที่มีพอ ให้เอาส่วนที่เหลือไปลบหาอิฐก้อนเล็ก แต่ถ้าอิฐก้อนใหญ่ไม่พอ ให้ใช้อิฐก้อนใหญ่ทั้งหมดที่มีลบออกจาก goal แล้วเช็คว่าอิฐเล็กที่มี พอเติมส่วนที่เหลือหรือไม่ ถ้าพอให้พิมพ์จำนวนอิฐเล็กที่ใช้ ถ้าไม่พิมพ์ -1
```
...
```text
แนะนำให้ใช้ if แทน loop และแนะนำให้ใช้ // 5
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ด ทดสอบ ส่ง OJ ด้วยตนเองทั้งหมด
```
