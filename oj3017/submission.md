...
```text
คิดเงินทั้งหมดที่รวมค่าบริการ10% และรวมvat7%
Input:
รับค่าอาหารและเครื่องดื่ม จำนวนเต็ม

Output:
เงินทั้งหมดที่รวมค่าบริการ10% และรวมvat7% เป็ฯทศนิยมสองตำแหน่ง

Constraints:
ค่าบริการเป็น10%ของค่าอาหารแต่ขั้นต่ำ50บาท ไม่เกิน1000บาท vatเป็น7%ของค่าอาหารและบริการ
```
...
Step 2: หาค่าบริการ10%ของค่าอาหาร
Step 3: ถ้าค่าบริการต่ำกว่า 50 ให้คิดค่าบริการเป็น50 
Step 4: ถ้าค่าบริการเกิน1000 ให้คิดเป็น1000
Step 5: คิดค่าvat7%ของค่าอาหารและบริการ
Step 6: แสดงผลเป็นทศนิยมสองตำแหน่ง
...
```text
เหมือนแผนแรก เพราะหลักการการคำนวนและลำดับขั้นตอนถูกต้อง
```
...
```text
เพราะค่าบริการไม่น้อยกว่าขั้นต่ำและไม่มากกว่าค่าสูงสุด
```
...
```text
เพื่อดูว่าขั้นต่ำของค่าบริการยังทำงานเมื่อค่าอาหารเป็น0
```
...
```text
เพราะค่าบริการสูงกว่าค่าสูงสุด
```
